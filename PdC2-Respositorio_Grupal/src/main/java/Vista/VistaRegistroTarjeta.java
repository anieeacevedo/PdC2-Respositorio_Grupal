...
public class VistaRegistroTarjeta extends JDialog {
    ...
    private void initComponents() {
        ...
        txtCVV = new JPasswordField(); // Enmascara los 3 dígitos
    ...
    private void guardarDatos() {
        ...
        // Validación simple para evitar guardar campos vacíos
        ...
        // Llamamos al controlador para que registre la tarjeta
        ...
        if (exito) {
            ...
            this.dispose(); // Cierra la ventana automáticamente tras un guardado exitoso
        } else {
